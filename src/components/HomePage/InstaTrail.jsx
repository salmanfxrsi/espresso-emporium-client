  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-12">
        <img className="rounded-[10px] mx-auto block" src={cup9} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup10} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup11} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup12} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup13} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup14} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup15} alt="" />
        <img className="rounded-[10px] mx-auto block" src={cup16} alt="" />
      </div>
    </div>
  );
};
